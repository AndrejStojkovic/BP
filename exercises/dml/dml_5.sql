...
JOIN Preporaka preporaka ON preporaka.k_ime_od = pm.k_ime
JOIN Video_zapis vz ON vz.naslov = preporaka.naslov
WHERE vz.vremetraenje >= 120 AND preporaka.ocena >= 4
